...
export default function Schema_2(props: Props) {
	...
	const back3: Atleta = props?.team.atletas.filter((atleta: Atleta) => atleta.posicao_id == 3)[2];
	...
	const middle5: Atleta = props?.team.atletas.filter((atleta: Atleta) => atleta.posicao_id == 4)[4];
	...
	return (
		<View style={styles.team}>
			...
			<View style={styles.lineMiddle}>
				...
				<Player athlete={middle5} capId={team.capitao_id} />
			</View>
